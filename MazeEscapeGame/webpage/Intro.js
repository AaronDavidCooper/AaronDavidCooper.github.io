...
var initials = "";
  ...
  push();
    ...
    strokeWeight(3);
    textSize(55);
    text("Maze Escape", width-width/3.7, height/5.2);
    textSize(35)
    text("Enter Initials : ___________", width-width/2.85, height/3);
    text(initials.toUpperCase(), width-width/4.8, height/3);
